...
enum wonder_vendor_subcmd {
	...
	WONDER_VEN_SUBCMD_SET_STATION_INFO = 0xA,
	WONDER_VEN_SUBCMD_SET_FEATURES = 0xB,
...
/* --- GET_CAP Attributes --- */
#define WONDER_VEN_ATTR_CAP_MAX_CH_SWITCH_TIME_SIZE WONDER_ATTR_SIZE_U32
...
enum wonder_vendor_cap_attr {
	...
	WONDER_VEN_ATTR_CAP_HBS_SUPPORT,
	WONDER_VEN_ATTR_CAP_NSS,
	WONDER_VEN_ATTR_CAP_HW_RA,
	WONDER_VEN_ATTR_CAP_MAX_CH_SWITCH_TIME,
...
#define WONDER_VEN_ATTR_MAC_TSF_SYS_TIME_BEFORE_SIZE WONDER_ATTR_SIZE_U64
#define WONDER_VEN_ATTR_MAC_TSF_SYS_TIME_AFTER_SIZE WONDER_ATTR_SIZE_U64

enum wonder_vendor_mac_tsf_attr {
	WONDER_VEN_ATTR_MAC_TSF_UNSPEC,
	WONDER_VEN_ATTR_MAC_TSF,
	WONDER_VEN_ATTR_MAC_TSF_SYS_TIME_BEFORE,
	WONDER_VEN_ATTR_MAC_TSF_SYS_TIME_AFTER,
...
enum wonder_vendor_channel_status_entry_attr {
	...
	WONDER_VEN_ATTR_CH_STATUS_ENTRY_TX_TRAFFIC_INDEX,
	WONDER_VEN_ATTR_CH_STATUS_ENTRY_RX_TRAFFIC_INDEX,
...
/* --- SET_STATION_INFO Attributes --- */
#define WONDER_VEN_ATTR_STA_INFO_ACTION_SIZE          WONDER_ATTR_SIZE_U32
#define WONDER_VEN_ATTR_STA_INFO_MAC_SIZE             WONDER_ADDR_LEN
#define WONDER_VEN_ATTR_STA_INFO_AID_SIZE             WONDER_ATTR_SIZE_U16
#define WONDER_VEN_ATTR_STA_INFO_CAPABILITY_MASK_SIZE WONDER_ATTR_SIZE_U32

enum wonder_vendor_sta_info_attr {
	WONDER_VEN_ATTR_STA_INFO_UNSPEC,
	WONDER_VEN_ATTR_STA_INFO_ACTION,
	WONDER_VEN_ATTR_STA_INFO_MAC,
	WONDER_VEN_ATTR_STA_INFO_AID,
	WONDER_VEN_ATTR_STA_INFO_CAPABILITY_MASK,
	WONDER_VEN_ATTR_STA_INFO_HT_CAP,
	WONDER_VEN_ATTR_STA_INFO_VHT_CAP,
	WONDER_VEN_ATTR_STA_INFO_HE_CAP,
	WONDER_VEN_ATTR_STA_INFO_HE_6GHZ_CAP,
	__WONDER_VEN_ATTR_STA_INFO_AFTER_LAST,
	WONDER_VEN_ATTR_STA_INFO_MAX = __WONDER_VEN_ATTR_STA_INFO_AFTER_LAST - 1
};

enum wonder_vendor_station_op {
	WONDER_VEN_ATTR_STA_OP_UNSPEC = 0,
	WONDER_VEN_ATTR_STA_OP_ADD = 1,
	WONDER_VEN_ATTR_STA_OP_UPDATE = 2,
	WONDER_VEN_ATTR_STA_OP_DEL = 3,
	WONDER_VEN_ATTR_STA_OP_QUERY = 4,
};

/* --- SET_FEATURES Attributes --- */
#define WONDER_VEN_ATTR_FEATURE_ID_SIZE          WONDER_ATTR_SIZE_U32
#define WONDER_VEN_ATTR_FEATURE_ENABLE_SIZE      WONDER_ATTR_SIZE_U8

enum wonder_vendor_feature_attr {
	WONDER_VEN_ATTR_FEATURE_UNSPEC,
	WONDER_VEN_ATTR_FEATURE_ID,
	WONDER_VEN_ATTR_FEATURE_ENABLE,
	__WONDER_VEN_ATTR_FEATURE_AFTER_LAST,
	WONDER_VEN_ATTR_FEATURE_MAX = __WONDER_VEN_ATTR_FEATURE_AFTER_LAST - 1
};
